...
class bizz_loop {					
	...
	function archive($args) {
		...
		if (function_exists('bizz_wp_pagenavi') && $args['enable_pagination']) {
			echo ($args['ajax_pagination']) ? "<".apply_filters('bizz_html5_nav', "div")." class=\"ajax-pagination\">" : "";
			bizz_wp_pagenavi();
			echo ($args['ajax_pagination']) ? "</".apply_filters('bizz_html5_nav', "div").">" : '';
		}
	...
	function search($args) {
		...
		echo "\t\t\t<h2>".esc_html_e($wp_query->query_vars['s'])."</h2>\n";
	...
	function nothing($args) {
		...
		echo "\t<".apply_filters('bizz_html5_article', "div")." class=\"post_box top\">\n";
		echo "\t\t<".apply_filters('bizz_html5_header', "div")." class=\"headline_area\">\n";
		echo "\t\t\t<h2>"._e('There&#8217;s nothing here.', 'bizz')."</h2>\n";
		echo "\t\t</".apply_filters('bizz_html5_header', "div").">\n";
		echo "\t\t<".apply_filters('bizz_html5_section', "div")." class=\"format_text\">\n";
		echo "\t\t\t".printf(__('If there were posts in the database, you&#8217;d be seeing them. Try <a href="%s">creating a post</a>, and see if that solves your problem.', 'bizz'), home_url() . '/wp-admin/post-new.php')."\n";
		echo "\t\t</".apply_filters('bizz_html5_section', "div").">\n";
		echo "\t</".apply_filters('bizz_html5_article', "div").">\n";
