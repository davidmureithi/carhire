...
?>
	    ...
	    <form class="file_editor" method="post" id="template" name="template" action="<?php echo admin_url("admin.php?page=bizz-editor&file=$file&save=true"); ?>">
			...
			<p>
				<input type="submit" class="save_button" id="custom_file_submit" name="custom_file_submit" value="<?php _e('Save', 'bizzthemes'); ?>" />
			</p>
		</form>
...
<?php
	    ...
	    // echo '<div id="message" class="updated fade themeinfo"><p>Rename your <code>custom-sample</code> folder to <code>custom</code>, otherwise theme will not work properly.</p></div>'."\n";
	}
