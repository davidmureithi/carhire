...
class Bizz_Widget_Search extends WP_Widget {
	...
	function Bizz_Widget_Search() {
		$widget_ops = array( 'classname' => 'search', 'description' => __( 'Control the output of your search form.' ) );
		$this->WP_Widget( "widgets-reloaded-bizz-search", __( 'Search' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'search_text' ); ?>"><?php _e( 'Search Text:' ); ?></label>
