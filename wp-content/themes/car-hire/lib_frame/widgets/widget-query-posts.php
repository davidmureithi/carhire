	...
	function widget( $args, $instance ) {
		...
		if ( have_posts() ) {
			...
			if (function_exists('bizz_wp_pagenavi') && $instance['enable_pagination']) {
			    echo ($instance['ajax_pagination']) ? "<".apply_filters('bizz_html5_nav', "div")." class=\"ajax-pagination\">" : "";
				bizz_wp_pagenavi();
				echo ($instance['ajax_pagination']) ? "</".apply_filters('bizz_html5_nav', "div").">" : "";
			}
...
?>
		...
		query_posts_input_checkbox( __( 'AJAX pagination', 'bizzthemes' ), $this->get_field_id( 'ajax_pagination' ), $this->get_field_name( 'ajax_pagination' ), checked( $instance['ajax_pagination'], true, false ) );
		...
		<small class="section">Thumbnail</small>
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_display' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_display'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_display' ); ?>" name="<?php echo $this->get_field_name( 'thumb_display' ); ?>" /> <?php _e( 'Thumbnails?', 'bizzthemes'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'thumb_selflink' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_selflink'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_selflink' ); ?>" name="<?php echo $this->get_field_name( 'thumb_selflink' ); ?>" /> <?php _e( 'Link to itself?', 'bizzthemes'); ?></label>
		</p>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_align' ); ?>">Thumbnail Align</label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_cropp' ); ?>">Thumbnail Crop</label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_filter' ); ?>">Thumbnail Filter (from 1 to 13)</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_sharpen' ); ?>">Thumbnail Sharpen (1 or 2)</label>
