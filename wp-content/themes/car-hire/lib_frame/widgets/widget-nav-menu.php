...
class Bizz_Widget_Nav_Menu extends WP_Widget {
	...
	function Bizz_Widget_Nav_Menu() {
		$widget_ops = array( 'classname' => 'nav-menu', 'description' => __( 'Control the output of your menus.' ) );
		$control_ops = array( 'width' => 525, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-nav-menu" );
		$this->WP_Widget( "widgets-reloaded-bizz-nav-menu", __( 'Navigation Menu' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'menu' ); ?>">Select a menu <a href="<?php echo esc_url('nav-menus.php'); ?>"><?php _e( 'edit menus' ); ?></a></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'container' ); ?>">Container</label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'container_id' ); ?>">Container ID</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'container_class' ); ?>">Container class</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'menu_id' ); ?>">Menu ID</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'before' ); ?>">Before menu</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'after' ); ?>">After menu</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'fallback_cb' ); ?>">Fallback CB</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'walker' ); ?>">Walker</label>
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['use_desc_for_title'], true ); ?> id="<?php echo $this->get_field_id( 'use_desc_for_title' ); ?>" name="<?php echo $this->get_field_name( 'use_desc_for_title' ); ?>" /> <?php _e( 'Display descriptions?' ); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'vertical' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['vertical'], true ); ?> id="<?php echo $this->get_field_id( 'vertical' ); ?>" name="<?php echo $this->get_field_name( 'vertical' ); ?>" /> <?php _e( 'Display vertically?' ); ?></label>
		</p>
		</div>
