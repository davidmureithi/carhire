...
class Bizz_Widget_Loop extends WP_Widget {
	...
	function Bizz_Widget_Loop() {
		$widget_ops = array( 'classname' => 'loop', 'description' => __( 'Loop widget displays your posts loop for current page or archive.' ) );
		$control_ops = array( 'width' => 550, 'height' => 350, 'id_base' => "widgets-reloaded-bizz-loop" );
		$this->WP_Widget( "widgets-reloaded-bizz-loop", __( 'WordPress Loop' ), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$args['ajax_pagination'] = isset( $instance['ajax_pagination'] ) ? $instance['ajax_pagination'] : false;
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['ajax_pagination'] = ( isset( $new_instance['ajax_pagination'] ) ? 1 : 0 );
	...
	function form( $instance ) {
		...
		<small class="section">Meta Settings</small>
		<p>
			<label for="<?php echo $this->get_field_id( 'post_author' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['post_author'], true ); ?> id="<?php echo $this->get_field_id( 'post_author' ); ?>" name="<?php echo $this->get_field_name( 'post_author' ); ?>" /> <?php _e( 'Post Author'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'post_date' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['post_date'], true ); ?> id="<?php echo $this->get_field_id( 'post_date' ); ?>" name="<?php echo $this->get_field_name( 'post_date' ); ?>" /> <?php _e( 'Post Date'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'post_comments' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['post_comments'], true ); ?> id="<?php echo $this->get_field_id( 'post_comments' ); ?>" name="<?php echo $this->get_field_name( 'post_comments' ); ?>" /> <?php _e( 'Post Comments'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'post_categories' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['post_categories'], true ); ?> id="<?php echo $this->get_field_id( 'post_categories' ); ?>" name="<?php echo $this->get_field_name( 'post_categories' ); ?>" /> <?php _e( 'Post Categories (posts only)'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'post_tags' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['post_tags'], true ); ?> id="<?php echo $this->get_field_id( 'post_tags' ); ?>" name="<?php echo $this->get_field_name( 'post_tags' ); ?>" /> <?php _e( 'Post Tags (posts only)'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'post_edit' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['post_edit'], true ); ?> id="<?php echo $this->get_field_id( 'post_edit' ); ?>" name="<?php echo $this->get_field_name( 'post_edit' ); ?>" /> <?php _e( 'Edit Post (visible to administrators)'); ?></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'post_meta' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['post_meta'], true ); ?> id="<?php echo $this->get_field_id( 'post_meta' ); ?>" name="<?php echo $this->get_field_name( 'post_meta' ); ?>" /> <?php _e( 'Display post meta on pages'); ?></label>
		</p>
		<small class="section">Archives Specific Options</small>
		<p>
			<label for="<?php echo $this->get_field_id( 'post_columns' ); ?>">How many Columns?</label> 
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['remove_posts'], true ); ?> id="<?php echo $this->get_field_id( 'remove_posts' ); ?>" name="<?php echo $this->get_field_name( 'remove_posts' ); ?>" /> <?php _e( 'Remove Post Content from Archives'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'full_posts' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['full_posts'], true ); ?> id="<?php echo $this->get_field_id( 'full_posts' ); ?>" name="<?php echo $this->get_field_name( 'full_posts' ); ?>" /> <?php _e( 'Display Full Posts'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'read_more' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['read_more'], true ); ?> id="<?php echo $this->get_field_id( 'read_more' ); ?>" name="<?php echo $this->get_field_name( 'read_more' ); ?>" /> <?php _e( 'Display <em>Read More...</em> text'); ?></label>
		</p>
		<p>
		...
		<small class="section">Pagination</small>
		<p>
			<label for="<?php echo $this->get_field_id( 'enable_pagination' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['enable_pagination'], true ); ?> id="<?php echo $this->get_field_id( 'enable_pagination' ); ?>" name="<?php echo $this->get_field_name( 'enable_pagination' ); ?>" /> <?php _e( 'Enable pagination'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'ajax_pagination' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['ajax_pagination'], true ); ?> id="<?php echo $this->get_field_id( 'ajax_pagination' ); ?>" name="<?php echo $this->get_field_name( 'ajax_pagination' ); ?>" /> <?php _e( 'Ajax pagination'); ?></label>
		</p>
		<small class="section">Thumbnail Options</small>
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_display' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_display'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_display' ); ?>" name="<?php echo $this->get_field_name( 'thumb_display' ); ?>" /> <?php _e( 'Display Thumbnails?'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'thumb_single' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_single'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_single' ); ?>" name="<?php echo $this->get_field_name( 'thumb_single' ); ?>" /> <?php _e( 'Display Thumbnail Images on Single Posts'); ?></label><br/>
			<label for="<?php echo $this->get_field_id( 'thumb_selflink' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumb_selflink'], true ); ?> id="<?php echo $this->get_field_id( 'thumb_selflink' ); ?>" name="<?php echo $this->get_field_name( 'thumb_selflink' ); ?>" /> <?php _e( 'Link thumbnail to itself?'); ?></label>
		</p>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_align' ); ?>">Thumbnail Alignment</label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_cropp' ); ?>">Thumb Crop Position</label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_filter' ); ?>">Thumb Filter (from 1 to 13)</label>
			<input type="text" class="smallfat code" id="<?php echo $this->get_field_id( 'thumb_filter' ); ?>" name="<?php echo $this->get_field_name( 'thumb_filter' ); ?>" value="<?php echo $instance['thumb_filter']; ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'thumb_sharpen' ); ?>">Thumb Sharpen (1 or 2)</label>
			<input type="text" class="smallfat code" id="<?php echo $this->get_field_id( 'thumb_sharpen' ); ?>" name="<?php echo $this->get_field_name( 'thumb_sharpen' ); ?>" value="<?php echo $instance['thumb_sharpen']; ?>" />
		</p>
		</div>
